...
Για εμένα προσωπικά η υλοποίηση του αλγορίθμου με C++ ήταν αρκετά πιο εύκολη καθώς
έχω συνηθίσει να γράφω σε C λόγω των μαθημάτων της σχολής και οι δύο αυτές γλώσσες
είναι αρκετά παρόμοιες. Το speedup που φαίνεται είναι το αναμενόμενο: οι χρόνοι
μειώνονται περίπου στην μέση με την αύξηση των threads. H ταχύτητα είναι ικανοποιητική,
βέβαια αρκετά πιο αργή από την υλοποίηση σε Java για λόγο που δεν γνωρίζω.
